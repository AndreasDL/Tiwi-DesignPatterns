...
public class DetailsPanel extends JPanel {
    ...
    private IContactList model;
    //private ContactView parent;
    // ContactView vervangen door Controller, later IController
    ...
    public DetailsPanel(IController controller, IContactList model) {
        //this.parent = parent;
    ...
    public void selectContact(String name) throws ContactException {
        ...
        if (name == null) {
            ...
            // Contact --> IContact
            IContact contact = model.getContact(name);
            if (contact == null) {
    ...
    private void handleEdit() {
        IContact contact = controller.createContact(); // hangt niet rechtstreeks van Contact-impl af
        contact.setName(nameField.getText());
        contact.setEmail(emailField.getText());
        if (name == null) {
            controller.addContact(contact);
        } else {
            controller.updateContact(name, contact);
        }
    }
