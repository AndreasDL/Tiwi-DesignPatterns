 ...
 * @author vongenae
 */
public class PsiDrukModel implements DrukModel {

    private static final String EENHEID = "psi";
    private PascalDrukModel model;
    private static final double VERHOUDING = 101325 / 14.7;

    public PsiDrukModel(PascalDrukModel model) {
        this.model = model;
    }
